...
assets = [
            ...
            ObserveAsset("binance", "ANKR", 48* sat, line=Line(58*sat, 48*sat, 99, "up"), horizon="down", ticker=BinanceClient.KLINE_INTERVAL_1HOUR),
            ...
            ObserveAsset("binance", "INJ", 15721* sat, line=None, horizon="down"),
